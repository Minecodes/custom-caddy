...
require (
	github.com/Tasudo/caddy-jailbait v0.0.0-20220817121447-bfac98e59881
	...
	github.com/mholt/caddy-webdav v0.0.0-20220728174539-14bd56b1afc9
	github.com/n0trace/caddy-ftp v0.0.0-20220620084448-52b094304d2e
